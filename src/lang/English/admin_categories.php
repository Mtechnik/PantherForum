...
$lang_admin_categories = array(
    ...
    'Add category help' => 'The name of the new category you want to add. You can edit the name of the category later (see below). Go to <a href="%s">%s</a> to add forums to your new category.',
