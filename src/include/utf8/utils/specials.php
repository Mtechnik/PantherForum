...
* be regarded as a non-word character, like ASCII control characters and pantherctuation. This has a "Roman"
* bias - it would be unaware of modern Chinese "pantherctuation" characters for example.
